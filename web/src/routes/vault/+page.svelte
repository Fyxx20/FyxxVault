...
<!-- FAB on mobile -->
<a href="/vault/add" class="fab-button lg:hidden fixed bottom-20 right-6 z-30 w-14 h-14 rounded-full bg-gradient-to-r from-[var(--fv-cyan)] to-[var(--fv-violet)] flex items-center justify-center">
